# HPC Training Module Outline Plan
...
| 2 | `101-02-Logging Into OnDemand and SSH.md` | Scribe | First OnDemand/SSH login after VPN connects | **Gap identified above** — not yet captured, recommend adding |
| 3 | `101-03-Understanding the PACE Ecosystem.md` | Markdown Explainer | PACE Homepage, Get Started with PACE | What PACE is, ICE vs. Phoenix vs. Firebird at a glance, PI vs. PACESHIP access paths |
| 4 | `101-04-Requesting ICE Access.md` | Markdown References | Request ICE Access (Form) | Short — just explain who needs to file it and link the form. No screenshots. |
...
| 3 | `201-03-Choosing Your GPU.md` | Markdown References | Part 3 — GPU decision tree | Explain the 3-question funnel, link out |
| 4 | `201-04-Using the VRAM Calculator.md` | Markdown Explainer | VRAM Calculator | Explain what it calculates, when to use it, walk through the math conceptually; link to the live tool |
| 5 | `201-05-Submitting Your First Job.md` | **Hybrid** | Sample Slurm Script + live terminal | Scribe recording of the terminal session (`sbatch`, `squeue`, checking `.out`) **plus** a markdown code block with the exact commands, copy-pasteable |
| 6 | `201-06-Further Reading.md` | Markdown Explainer | Intro-To-PACE-ICE (Guru) | This is the deep-dive off ramp |
...
| 3 | `301-03-Validating Your Job Before Submission.md` | Markdown References | PACE Job Submission Validator (Zach Wallace) | Same — when/why to use it, contact link |
| 4 | `301-04-Checking System Status.md` | Markdown Explainer | PACE System Status | Short — teaches people to check this before assuming their own script is broken |
...
| # | File | Type | Source / Content | Notes |
|---|------|------|-------------------|-------|
| 1 | `401-01-Running LLMs with Ollama.md` | **Hybrid** (likely) | PACE + HAAG: Ollama KB | This KB likely has real install/run CLI steps — treat like 201-05 (Scribe + code blocks) once confirmed |
...
| — | `README.md` | — | — | Sequences 401-01 → 401-04, notes 03/04 as coming soon |
